              ...
              <TransitionGroup name="list" tag="div" class="flex-list-inner">
                ...
                <VFlexTableCell>
                  <div>
                    ...
                    <p class="light-text text-overflow" :class="item.status === 'succeeded'? 'is-link':''" @click = "moveToDetail(item)">{{
                      item.description
                    }}</p>
                    <p class="mt-2" @click="copyLink(item.checkoutLink)" >Checkout link <i style="color: var(--info);" class="fas fa-copy cu-pointer" aria-hidden="true"></i></p>
                  </div>
                  </VFlexTableCell>
                  ...
                  <VFlexTableCell>
                    <span class="" style="font-size: 600; font-size: 18px">${{ item.amount }}</span>
                  </VFlexTableCell>
                  ...
                  <VFlexTableCell :column="{ media: true, grow: true }">
                    ...
                    <div>
                      <span class="item-name dark-inverted"
                        >{{ item?.client_info?.username? item?.client_info?.username : 'N/A' }}
                      </span>
                      <span class="item-meta">
                  ...
                  <VFlexTableCell>
                    <VTag
                    >
                      <p style="font-size: 1rem; font-weight: 600;  text-transform: uppercase;"> {{ item.status }}</p> 
                    </VTag>
                  </VFlexTableCell>
                  <VFlexTableCell>
                 

                    <VAvatar  :picture="'/'+item.type+'.png'" squared size="medium"></VAvatar>
                  </VFlexTableCell>
