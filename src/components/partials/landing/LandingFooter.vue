    ...
    <div class="container">
      <div class="footer-head">
        <div class="head-text">
          ...
          <p>Feel Free To Contact By Phone Or With Our Form If You Have
            <br/>
             Any Questions Or Need Assistance On Product Information.</p>
        </div>
        <div class="head-action">
          <div class="buttons">
            <a
              href="https://arez.io/images/logo-white.svg"
        ...
        <div class="column is-4">
          <div class="p-t-10 p-b-10">
            ...
            <div class="footer-description p-t-10 p-b-10">
              Arez is the best physical security workforce management software. Track, manage and streamline all your security operations processes.
            </div>
          </div>
          <div>
            <span class="moto">
          ...
          <div class="columns is-flex-tablet-p">
            ...
            <div class="column">
              <ul class="footer-column">
                ...
                <li class="column-item">
                  <a href="https://cssninja.io/faq/licenses">Privacy Policy</a>
                </li>
                <li class="column-item">
                  <a href="https://cssninja.io/faq/licenses">Terms & Conditions</a>
                </li>
      ...
      <div class="footer-copyright has-text-centered">
        <p>
          ...
          >&copy;</span> 2023-2024 |
          <a href="https://cssninja.io">VMS Arez</a> | All Rights Reserved.
        </p>
      </div>
    </div>
