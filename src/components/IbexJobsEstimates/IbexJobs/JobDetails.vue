    ...
    <div class="columns is-multiline">
      <div class="column is-12">
        <div class="columns is-multiline">
          ...
          <div v-if="tab === 'management'" class="column is-12">
            <div class="columns is-multiline">
                    ...
                    <div class="incoming">
                      <VFlexTable rounded :data="data" :columns="columns">
                        <template #body-cell="{ row, column, value }">
                          <template
                            v-if="
                              column.key === 'type' && row.type === 'messages'
                            "
                          >
                          ...
                          <template
                            v-else-if="
                              column.key === 'type' && row.type === 'tasks'
                            "
                          >
                          ...
                          <template v-else-if="column.key === 'actions'">
                            <a tabindex="0" class="action-link is-pushed-mobile"
                              >Open</a
                            >
                          </template>
