  ...
  <div class="list-widget tabbed-widget" :class="[straight && 'is-straight']">
    ...
    <div class="inner-list-wrapper" :class="[!state && 'is-active']">
      <div class="inner-list">
        <div>
          <VBlock v-for="todo in 6" center lighter class="inner-list-item">
            <template #icon>
              <VAnimatedCheckbox
                v-model="modelValue"
                value="todo"
            ...
            <template #action>
              <span class="tag is-rounded"> pending </span>
            </template>

            <a href="#">Call Julio to update</a>
            <span>10:30 AM</span>
          </VBlock>
        </div>
      </div>
    ...
    <div class="inner-list-wrapper" :class="[state && 'is-active']">
      <div class="inner-list">
        <div>
          <VBlock v-for="todo in 10" center lighter class="inner-list-item">
            <template #icon>
              <VAnimatedCheckbox
                v-model="modelValue"
                value="todo"
