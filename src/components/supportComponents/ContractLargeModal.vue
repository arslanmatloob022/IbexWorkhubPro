  ...
  >
    ...
    <div class="form-content">
      ...
      <div class="" v-show="currentContent === 1">
        ...
        <!-- Button -->
        <div class="column is-12 pb-4" style=" display: flex; align-items: center; justify-content:flex-end; margin-top: 2rem; " >
              <VButton type="button"  @click="()=>{ FormData.id ? addCompanyHandler() : currentContent = 2 }"  
              class="next-tag" style="width:6rem;" >
                Next
              </VButton>
        </div>
      </div>
      ...
      <div class="" >
        ...
        <!--  Map View -->
        <div class="column is-12 pb-2" style=" margin-top: .3rem;" >
                <div class="revenue-stat">
                 <div
                  id="partnerMap"
                  style="height: 250px; width: 100%; border-radius: 10px;  border-radius: 1rem;"
                ></div>
            </div>
        </div>
      </div>
...
.input[type="date"]::-webkit-calendar-picker-indicator {
  ...
  color: #495057; /* Adjust icon color as needed */
