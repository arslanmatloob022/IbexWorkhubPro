...
const emit = defineEmits<{
  ...
  (e: "update-jobs", value: number | null): void;
}>();

const updateJobs = () => {
  emit("update-jobs", rotaJobs.value);
};
      ...
      <div class="columns is-multiline mb-3">
        ...
        <div v-if="addjobs" class="field column is-6 mb-0">
          <VField>
            ...
            <VControl>
              <VInput v-model="jobData.id" type="text" placeholder="Job id" />
            </VControl>
          </VField>
        </div>
        <div v-if="addjobs" class="field column is-6 mb-0">
        ...
        <div class="column is-12">
          <FullCalendar :options="calendarOptions">
            <template v-slot:eventContent="arg">
              <div class="p-2 is-flex" style="position: relative; width: 100%">
                <span
                  style="
                    position: absolute;
                    top: 0.7rem;
