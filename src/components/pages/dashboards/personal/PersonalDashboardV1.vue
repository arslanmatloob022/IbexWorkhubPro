...
<template>
  <div class="personal-dashboard personal-dashboard-v1">
    ...
    <div class="dashboard-header">
      <VAvatar
      :picture="userSession.user && userSession.user.profileImage?userSession.user.profileImage: '/images/avatars/svg/vuero-1.svg'"
        size="large"
      />
      <!-- -->
      <div class="start">
        <h3>Welcome back, {{userSession.user && userSession.user.first_name}} {{userSession.user && userSession.user.last_name}} </h3>
