...
const openUnitModalHandler = (id: any = "") => {
  currentSelectedId.value = id;
  openCostUnitModal.value = !openCostUnitModal.value;
};

const filteredData = computed(() => {
  if (!filters.value) {
    return costUnitsList.value;
  } else {
    const filterRe = new RegExp(filters.value, "i");
    return costUnitsList.value.filter((item) => {
...
<template>
  <div>
          ...
          <div class="tile-grid-item">
            <div class="tile-grid-item-inner">
              ...
              <VDropdown icon="feather:more-vertical" spaced right>
                <template #content>
                  <a
                    @click="openUnitModalHandler(item.id)"
                    role="menuitem"
    ...
    <UnitAddUpdateModal
      ...
      :unitId="currentSelectedId"
      @update:modalHandler="
        openCostUnitModal = false;
        currentSelectedId = '';
      "
