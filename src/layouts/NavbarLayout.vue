    ...
    <Navbar :theme="props.theme">
      ...
      <template #links>
        ...
        >
          ...
          <a
            :class="[
              (activeSubnav === 'networks' ||
                route.path.startsWith('/navbar/networks')) &&
                'is-active',
            ]"
            class="centered-link centered-link-toggle"
            tabindex="0"
            role="button"
            @keydown.space.prevent="toggleSubnav('networks')"
            @click="toggleSubnav('networks')"
          >
            <i
              aria-hidden="true"
              class="iconify"
          ...
          <a
            :class="[
              (activeSubnav === 'jobs' ||
                route.path.startsWith('/navbar/jobs')) &&
                'is-active',
            ]"
            class="centered-link centered-link-toggle"
            tabindex="0"
            role="button"
            @keydown.space.prevent="toggleSubnav('jobs')"
            @click="toggleSubnav('jobs')"
          >
            <i
              aria-hidden="true"
              class="iconify"
          ...
          <a
            :class="[
              (activeSubnav === 'timesheet' ||
                route.path.startsWith('/navbar/timesheet')) &&
                'is-active',
            ]"
            class="centered-link centered-link-toggle"
            tabindex="0"
            role="button"
            @keydown.space.prevent="toggleSubnav('timesheet')"
            @click="toggleSubnav('timesheet')"
          >
            <i
              aria-hidden="true"
              class="iconify"
      ...
      <template #subnav>
        ...
        >
          <NetworksSubnav
            :class="[activeSubnav === 'networks' && 'is-active']"
          />

          <JobsSubnav :class="[activeSubnav === 'jobs' && 'is-active']" />

          <TimeSheetSubnav
            :class="[activeSubnav === 'timesheet' && 'is-active']"
          />
