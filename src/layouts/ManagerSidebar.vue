  ...
  <div class="sidebar-layout">
    ...
    <Transition name="slide-x">
      ...
      >
        ...
        <template #links>
          <li>
            <RouterLink to="/sidebar/manager/projects" class="single-link">
              <span class="icon">
          ...
          <li>
            <RouterLink to="/sidebar/manager/calendar" class="single-link">
              <span class="icon">
          ...
          <li>
            <RouterLink to="/sidebar/manager/profile" class="single-link">
              <span class="icon">
