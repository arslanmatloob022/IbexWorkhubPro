  ...
  <div class="sidebar-layout">
    ...
    >
      <template #links>
        ...
        <li>
          <a
            :class="[activeMobileSubsidebar === 'networks' && 'is-active']"
            data-content="Networks"
            aria-label="View network"
            tabindex="0"
            role="button"
            @keydown.space.prevent="switchSidebar('network')"
            @click="switchSidebar('network')"
          >
            <i class="iconify sidebar-svg" data-icon="feather:aperture" aria-hidden="true"></i>
          </a>
        </li>
        ...
        <li>
          <a
            :class="[activeMobileSubsidebar === 'job' && 'is-active']"
            data-content="Jobs"
            aria-label="View job"
            tabindex="0"
            role="button"
            @keydown.space.prevent="switchSidebar('job')"
            @click="switchSidebar('job')"
          >

            <i class="iconify sidebar-svg" data-icon="feather:airplay" aria-hidden="true"></i>
          </a>
        </li>
        ...
        <li>
          <a
            :class="[activeMobileSubsidebar === 'timesheet' && 'is-active']"
            data-content="timesheets"
            aria-label="View timesheet"
            tabindex="0"
            role="button"
            @keydown.space.prevent="switchSidebar('timesheet')"
            @click="switchSidebar('timesheet')"
          >

            <i class="iconify sidebar-svg" data-icon="feather:map" aria-hidden="true"></i>
          </a>
        </li>
    ...
    <Transition name="slide-x">
      <KeepAlive>
        ...
        />
        <NetworksSubsidebar
        v-else-if="isDesktopSidebarOpen && activeMobileSubsidebar === 'network'"
        @close="isDesktopSidebarOpen = false"
        />
        <JobsSubsidebar
        v-else-if="isDesktopSidebarOpen && activeMobileSubsidebar === 'job'"
        @close="isDesktopSidebarOpen = false"
        />
        <TimeSheetsSubsidebar
        v-else-if="isDesktopSidebarOpen && activeMobileSubsidebar === 'timesheet'"
        @close="isDesktopSidebarOpen = false"
        />
