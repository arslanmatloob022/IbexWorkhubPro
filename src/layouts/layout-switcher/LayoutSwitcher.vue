                  ...
                  >
                    ...
                    <div class="column is-6">
                      <RouterLink
                        ...
                        class="layout-item"
                        :class="[
                          layoutSwitcher.dynamicLayoutId === 'navbar-fade' &&
                            'is-active',
                        ]"
                        @keydown.space.prevent="
                          () => {
                  ...
                  >
                    <div class="column is-6">
                      <RouterLink
                        ...
                        class="layout-item"
                        :class="[
                          layoutSwitcher.dynamicLayoutId ===
                    ...
                    <div class="column is-6">
                      <RouterLink
                        ...
                        :class="[
                          layoutSwitcher.dynamicLayoutId ===
                            'navbar-dropdown-colored' && 'is-active',
                        ]"
                        @keydown.space.prevent="
                          () => {
                            layoutSwitcher.setDynamicLayoutId(
                              'navbar-dropdown-colored'
                            );
                            isModalOpen = false;
                          }
                        "
                  ...
                  >
                    ...
                    <div class="column is-6">
                      <RouterLink
                        ...
                        :class="[
                          layoutSwitcher.dynamicLayoutId ===
                            'sidebar-color-curved' && 'is-active',
                        ]"
                        @keydown.space.prevent="
                          () => {
                            layoutSwitcher.setDynamicLayoutId(
                              'sidebar-color-curved'
                            );
                            isModalOpen = false;
                          }
                        "
                    ...
                    <div class="column is-6">
                      <RouterLink
                        ...
                        :class="[
                          layoutSwitcher.dynamicLayoutId ===
                            'sidebar-labels-hover' && 'is-active',
                        ]"
                        @keydown.space.prevent="
                          () => {
                            layoutSwitcher.setDynamicLayoutId(
                              'sidebar-labels-hover'
                            );
                            isModalOpen = false;
                          }
                        "
