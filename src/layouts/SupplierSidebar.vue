        ...
        <template #links>
          ...
          <li>
            ...
            >
              ...
              <RouterLink class="is-submenu" to="/sidebar/contractor/projects">
                <span class="icon" id="cus-spanLink">
                  <i class="lnir lnir-list-alt" aria-hidden="true"></i>
                </span>
              </RouterLink>
              <RouterLink class="is-submenu" to="/sidebar/contractor/calendar">
                <span class="icon" id="cus-spanLink">
                  <i class="lnir lnir-appointment" aria-hidden="true"></i>
                </span>
              </RouterLink>
              <RouterLink class="is-submenu" to="/sidebar/contractor/profile">
                <span class="icon" id="cus-spanLink">
