...
export const useLayoutSwitcher = defineStore('layoutSwitcher', () => {
  ...
  console.log("has dynamic layout", computed(() => isNavbarRoute.value || isSidebarRoute.value))
  const hasDynamicLayout = true
  ...
  function setDynamicLayoutId(theme: NavbarComponentsId | SidebarComponentsId) {
    console.log('setDynamicLayoutId value changed', theme)
